...
function App() {
    ...
    return ( <
        div className = {
            `app ${location.pathname === '/' ? '' : 'app--black'}`
        } >
        <
        PageHeader setIsWalletWindowVisible = {
            setIsWalletWindowVisible
        }
        /> <
        Routes >
        <
        ...
        /> <
        Route path = 'dapp/stake-eth'
        element = { < StakeEthPage / >
        }
        /> <
        Route path = 'dapp/stake-lsd'
        element = { < StakeLsdPage / >
        }
        /> <
        Route path = 'dapp/stake-lp'
        element = { < StakeLpPage / >
        }
        /> <
        /Routes>

        {
            isWalletWindowVisible &&
                ...
                ModalWindow >
                <
                ConnectWallet setIsWalletWindowVisible = {
                    setIsWalletWindowVisible
                }
            /> <
            /ModalWindow>
