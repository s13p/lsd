    ...
    try {
        ...
        dispatch({
            ...
            payload: {
                ...
                ethAmount: ethAmount,
                lsdExchangeRate: lsdExchangeRate
            }
        })
        dispatch({
            type: ETH_INFO_LOADING,
...
const stakeLpInfo = () => async dispatch => {
    ...
    try {
        ...
        const {
            ...
            _reserve1,
            _blockTimestampLast
        } = await pairTokenContract.getReserves()
...
const getPersonalLsdInfo = (address) => async dispatch => {
    ...
    try {
        dispatch({
            type: LSD_PERSONAL_INFO_LOADING,
            payload: true
        })
